...
Do **not** write ad-hoc notes to `~/.codex/memories` or other shadow paths from this skill.
...
```text
Should we ship the next Codex team workflow as alpha now, or hold until the control-plane UI is more complete?
```
