...
For non-trivial functionality, use a researcher subagent only when the user explicitly asked for multi-agent or parallel work:
...
### AI/LLM Integration
- LLM SDK → official provider docs for latest behavior
