...
description: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs a Codex-ready PRD-to-SRS lane instead of vague planning prose.
origin: upstream
---
...
If useful, point to the next Codex team lane:
...
HANDOFF
- what should happen next and which Codex team lane should take it
```
...
- The resulting plan is reusable across Codex and other coding-agent planning surfaces.
